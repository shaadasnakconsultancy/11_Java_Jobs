...
@Service
public class  ResultunitsEndBoundedExcelReader{
	@Autowired
	GlobalExceptionHandler_AND_EmailSender GlobalExceptionHandler_AND_EmailSender;
	static Logger logger=LoggerFactory.getLogger(ResultunitsEndBoundedExcelReader.class);
	Object value =null;
	int columnIndex=0;
	Row row=null;
	File excelFile2=null;
	Result_Units_DTO Result_Units_DTO =null;
	List<Result_Units_DTO> rowData = new ArrayList<>();
	 public   List<Result_Units_DTO> readDataBetweenEndMarkers(File excelFile) {
		   ...
		   XSSFWorkbook workbook=null;
	        ...
	        try {
	          ...
	          // ⭐ Required to calculate formulas
	            ...
	            XSSFSheet sheet = workbook.getSheet("Result Units");
	            if (sheet == null) {
...
System.out.println(sheet.getSheetName());
	            ...
	            if(lastColumn==-101 || lastRow==-101) {
	            	...
	            	// logger.info("not able to find END marker in column or row in ResultunitsEndBoundedExcelReader() in :: > "+ ResultunitsEndBoundedExcelReader.class.getName());
	            	GlobalExceptionHandler_AND_EmailSender.handleException(  new PrintLog_AND_SendEmail_Exception(
	                         "ResultunitsEndBoundedExcelReader.class",
	                         "readDataBetweenEndMarkers()",
	                         excelFile.getName(),
	                         "END marker not found in COLUMN or ROW in Sheet - Result Units",
	            ...
	            for (int r = 1; r <= lastRow; r++) {
	                ...
	                if (row == null) { ; continue ;}
	                  ...
	                  Result_Units_DTO=new Result_Units_DTO();
	                for (int c = 0; c <= lastColumn; c++) {
	                    ...
	                    if(c==0) {
	    					...
	    					{
//	                    		Result_Units_DTO.setSno(String.valueOf(value).trim());
	                    		  BigDecimal bd = new BigDecimal(value.toString().trim());
	                    		  Result_Units_DTO.setSno(String.valueOf(bd.intValue()));
	                    	...
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setFy(String.valueOf(value).trim());
	    					}
	                    	value = null;
	                    	...
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setActual(String.valueOf(value).trim());
	    					}else {
	                    	value = null;
	    					}
	                    	 columnIndex++;
	                    	...
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setCountry(String.valueOf(value).trim());
	    					}else {
	                    	value = null;
	    					}
	                    	 columnIndex++;
	                    	...
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setFirstHalf(String.valueOf(value).trim());
	    					}else {
	                    	value = null;
	    					}
	                    	 columnIndex++;
	                    	...
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setSecondHalf(String.valueOf(value).trim());
	    					}else {
	                    	value = null;
	    					}
	                    	 columnIndex++;
	                    	...
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setModel(String.valueOf(value).trim());
	    					}else {

	    						Result_Units_DTO.setModel("0");
	    					}
	                     	columnIndex++;
	                    }else if(c==7) {
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setGroup(String.valueOf(value).trim());
	    					}else {
	                    	value = null;
	    					}
	                    	 columnIndex++;
	                    	...
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setApr(String.valueOf(value).trim());
	    					}else {
	    						Result_Units_DTO.setApr("0");
	    					}
	                    	 columnIndex++;
	                    }else if(c==9) {
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setMay(String.valueOf(value).trim());
	    					}else {
	    						Result_Units_DTO.setMay("0");
	    					}
	                    	 columnIndex++;
	                    }else if(c==10) {
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setJun(String.valueOf(value).trim());
	    					}else {
	    						Result_Units_DTO.setJun("0");
	    					}
	                    	 columnIndex++;
	                    }else if(c==11) {
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setJul(String.valueOf(value).trim());
	    					}else {
	    						Result_Units_DTO.setJul("0");
	    					}
	                    	 columnIndex++;
	                    }else if(c==12) {
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setAug(String.valueOf(value).trim());
	    					}else {
	    						Result_Units_DTO.setAug("0");
	    					}
	                    	 columnIndex++;
	                    }else if(c==13) {
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setSep(String.valueOf(value).trim());
	    					}else {
	    						Result_Units_DTO.setSep("0");
	    					}
	                    	 columnIndex++;
	                    }else if(c==14) {
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setOct(String.valueOf(value).trim());
	    					}else {
	    						Result_Units_DTO.setOct("0");
	    					}
	                    	 columnIndex++;
	                    }else if(c==15) {
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setNov(String.valueOf(value).trim());
	    					}else {
	    						Result_Units_DTO.setNov("0");
	    					}
	                    	 columnIndex++;
	                    }else if(c==16) {
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setDec(String.valueOf(value).trim());
	    					}else {
	    						Result_Units_DTO.setDec("0");
	    					}
	                    	 columnIndex++;
	                    }else if(c==17) {
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setJan(String.valueOf(value).trim());
	    					}else {
	    						Result_Units_DTO.setJan("0");
	    					}
	                    	 columnIndex++;
	                    }else if(c==18) {
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setFeb(String.valueOf(value).trim());
	    					}else {
	    						Result_Units_DTO.setFeb("0");
	    					}
	                    	 columnIndex++;
	                    }else if(c==19) {
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setMar(String.valueOf(value).trim());
	    					}else {
	    						Result_Units_DTO.setMar("0");
	    					}
	                    	 columnIndex++;
	                    }else if(c==20) {
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setMonth(String.valueOf(value).trim());
	    					}else {
	                    	value = null;
	    					}
	                    	 columnIndex++;
	                    	...
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setAccumulated (String.valueOf(value).trim());
	    					}else {
	                    	value = null;
	    					}
	                    	 columnIndex++;
	                    	...
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setLastMonth(String.valueOf(value).trim());
	    					}else {
	                    	value = null;
	    					}
	                    	 columnIndex++;
	                    	...
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setRawLabel(String.valueOf(value).trim());
	    					}else {

	    						Result_Units_DTO.setRawLabel("0");
	    					}
	                    	 columnIndex++;
	                    }else if(c==24) {
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setBaseModel(String.valueOf(value).trim());
	    					}else {

	    						Result_Units_DTO.setBaseModel("0");
	    					}
	                    	 columnIndex++;
	                    }else if(c==25) {
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setVehicleType(String.valueOf(value).trim());
	    					}else {
	                    	value = null;
	    					}
	                     	columnIndex++;
	                    	...
	                    	if(null!=value && !"".equals(value) && !"-".equals(value.toString().trim()))
	    					{
	                    		Result_Units_DTO.setxModelCode(String.valueOf(value).trim());
	    					}else {
	    						Result_Units_DTO.setxModelCode("0");
	    					}
	                     	columnIndex++;
	                    }
	                ...
	                columnIndex=0;
	                rowData.add(Result_Units_DTO == null ? null :Result_Units_DTO);
	           ...
	           // logger.info("not able to read data from cell in readDataBetweenEndMarkers()");
	            GlobalExceptionHandler_AND_EmailSender.handleException(  new PrintLog_AND_SendEmail_Exception(
	                    ...
	                    "readDataBetweenEndMarkers()",
	                    excelFile.getName(),
	                    "not able to read data from cell for sheet -> Result Units",
...
//	         	   System.err.println("not able to find END marker in column in findLastColumnBeforeEnd() ");
	  	         //  logger.info("not able to find END marker in column in findLastColumnBeforeEnd() in :: > "+ ResultunitsEndBoundedExcelReader.class.getName());
	        ...
	        for (int r = 0; r <= lastRow; r++) {
	            ...
	            if (val != null && "END".equalsIgnoreCase(val.toString().trim())) {
	         	 ...
	         	 //  System.err.println("not able to find END marker in Row in findLastColumnBeforeEnd() ");
	  	         //  logger.info("not able to find END marker in Row in findLastColumnBeforeEnd() in :: > "+ ResultunitsEndBoundedExcelReader.class.getName());
...
//	                 * read cached Excel result
	        ...
	        catch (Exception e)
	        {
	            ...
	            GlobalExceptionHandler_AND_EmailSender.handleException(  new PrintLog_AND_SendEmail_Exception(
	                    ...
	                    excelFile2.getName(),
	                    "not able to read data from cell for sheet -> Result Units",
	                   " so processing other files, check logs"
